...
class LoginForm extends Component {
  ...
  getRedirectURL = () => {
    ...
    return 'https://nayeemspotify.ccbp.tech/login'
  }

  openLoginModal = () => {
    // YOU NEED TO ADD YOUR CLIENT ID HERE
    const clientId = 'c1b6fde8a86f4eaab1a4e8ade8413b62'

    const redirectUrl = this.getRedirectURL()

    const url = `https://accounts.spotify.com/authorize?client_id=${clientId}&response_type=token&redirect_uri=${redirectUrl}&scope=streaming%20user-modify-playback-state%20user-read-currently-playing%20user-read-playback-position%20user-read-playback-state%20user-read-recently-played%20user-top-read%20user-read-private%20user-read-email%20playlist-read-private%20playlist-modify-public%20playlist-modify-private%20user-library-read%20user-library-modify%20user-follow-read%20user-follow-modify&state=34fFs29kd09&show_dialog=true`
